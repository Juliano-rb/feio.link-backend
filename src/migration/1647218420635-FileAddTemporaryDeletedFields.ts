...
export class FileAddTemporaryDeletedFields1647218420635 implements MigrationInterface {
    name = 'FileAddTemporaryDeletedFields1647218420635'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, "age" integer NOT NULL, "sex" integer NOT NULL)`);
